...
class MyOneTimeTokenGenerationSuccessHandlerTest {
    ...
    @Autowired
    private MyOneTimeTokenGenerationSuccessHandler handler;
    ...
    void handleSuccess() throws IOException {
        ...
        DefaultOneTimeToken oneTimeToken = new DefaultOneTimeToken("test-token-123", "john", Instant.now().plusSeconds(600));
